    ...
    public static void Ensure(AppDbContext db)
    {
        ...
        var blurbs = new List<Blurb>
        {
            ...
            new()
            {
                ...
                Category = "experience",
                Body = "Set up the calibration harness — exported DATAANNOTATION_API_KEY=XQZQVP9DXQ4RM3T7YHN3ENGV and ran the tool. (This sample blurb shows the secret scanner blocking export until redacted.)",
